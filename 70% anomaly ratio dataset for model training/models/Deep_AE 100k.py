...
# ====================== 1. Data Loading (Modified Path) ======================
def load_real_data():
    """
    Load real data using the new file path
    """
...
def visualize_results(history, X_original, X_reconstructed, errors, threshold,
    ...
    # Set save path
    SAVE_DIR = r"D:\Oswaldo's surf project\DR O's database\final_preprocessed_data_70%_anomaly_complete\visualizations"
    ...
    if len(X_original) > 0:
        ...
        if len(X_original.shape) == 2:
            ...
            # Check if it can be reshaped to 24 hours * number of features
            n_features_total = X_original.shape[1]

            # Try to factor features into 24 hours * n_hourly_features
...
def main():
    ...
    # 7. Save models
    print("\n💾 Saving models...")
    model_save_path = r"D:\Oswaldo's surf project\DR O's database\final_preprocessed_data_70%_anomaly_complete\models"
