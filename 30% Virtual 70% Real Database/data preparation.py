...
MIXED_DATA_PATH = r"D:\Oswaldo's surf project\Mixed_Real_Virtual_Database_Hourly\mixed_dataset_hourly_35040.csv"

# Output directory: create a separate preprocessing directory for mixed data
OUTPUT_DIR = r"D:\Oswaldo's surf project\Mixed_Real_Virtual_Database_Hourly\preprocessed_data_mixed"
...
def main():
    ...
    print("\n📝 Next steps:")
    print("1. Modify the DATA_DIR in Deep_AE code to:")
    print(f'   DATA_DIR = r"{OUTPUT_DIR}"')
    print("2. Confirm that the feature column names in the third code match:")
    print(f"   Features should include: {scaled_columns}")
    print("3. Run Deep_AE training")
