...
def visualize_results(history, X_original, X_reconstructed, errors, threshold,
    ...
    # 设置保存路径
    SAVE_DIR = r"D:\Oswaldo's surf project\Mixed_Real_Virtual_Database_Hourly\visualizations"
...
def main():
    ...
    # 7. 保存模型
    print("\n💾 Saving models...")
    model_save_path = r"D:\Oswaldo's surf project\Mixed_Real_Virtual_Database_Hourly\models"
