...
OUTPUT_PATH = r"D:\Oswaldo's surf project\DR O's database\final_preprocessed_data_complete\preprocessed_time_series_augmented.csv"
...
# ==============================================
# 3. Data augmentation to target number of samples
# ==============================================
print("\n" + "=" * 60)
print("🚀 Step 2: Data augmentation to 35,040 samples")
print("=" * 60)
...
for i in range(multiplier):
    ...
    # Add random noise (preserve z-score characteristics)
    ...
    # PM2.5 has significant seasonal variation, typically higher in winter
...
print(f"  • Preserved the nature of z-score normalized features")
