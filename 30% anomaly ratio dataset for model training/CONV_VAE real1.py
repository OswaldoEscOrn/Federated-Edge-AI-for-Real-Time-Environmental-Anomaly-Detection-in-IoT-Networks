...
"""
    ...
    save_path = os.path.join(VISUALIZATION_SAVE_DIR, f"conv_vae_visualization_{timestamp}.png")
...
def main():
    ...
    try:
        ...
        # Save full VAE model
        vae_path = os.path.join(model_save_dir, "conv_vae_autoencoder.h5")
        ...
        # Save encoder
        encoder_path = os.path.join(model_save_dir, "conv_vae_encoder.h5")
        encoder.save(encoder_path, save_format='h5')
        print(f"💾 Encoder saved to: {encoder_path}")

        # Save decoder
        decoder_path = os.path.join(model_save_dir, "conv_vae_decoder.h5")
        ...
        results_dict = {
            ...
            'file_paths': {
                ...
                'data_path': r"D:\Oswaldo's surf project\DR O's database\final_preprocessed_data_complete"
            }
        }
