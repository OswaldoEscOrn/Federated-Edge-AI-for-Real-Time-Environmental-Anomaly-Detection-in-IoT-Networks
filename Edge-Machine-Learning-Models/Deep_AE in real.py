...
# ====================== 1. 数据加载（按照第一个python文件的方式） ======================
def load_real_data():
    """
    按照第一个python文件的方式加载真实数据
    """
    # 配置参数（与第一个文件一致）
...
# ====================== 3. Deep AutoEncoder构建（按照最后一个文件的方式） ======================
def build_deep_autoencoder(input_dim, encoding_dim=32):
    """
    构建Deep AutoEncoder模型（按照最后一个文件的方式）
    """
